...
OBJ_DATA *create_object( OBJ_INDEX_DATA *pObjIndex, int level )
{
    ...
    *obj		= obj_zero;
    ...
    else if (( obj->pIndexData->vnum >= 29600 && obj->pIndexData->vnum <= 29800) 
         || ( obj->pIndexData->vnum >= 27650 && obj->pIndexData->vnum <= 27670 )
	|| ( obj->pIndexData->vnum >= 2640 && obj->pIndexData->vnum <= 2660))
    {
