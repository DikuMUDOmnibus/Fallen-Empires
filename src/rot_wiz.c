...
void do_pset( CHAR_DATA *ch, char *argument )
{
	...
	send_to_char( "  quest weapon immune beast\n\r",                ch );
	...
	if (IS_JUDGE(ch)) {
		...
		send_to_char( "You cannot set beast.\n\r", ch );
	return;
    }
	...
	if (IS_JUDGE(ch)) {
		...
		send_to_char( "You cannot set aura points.\n\r", ch );
	return;
    }
	...
	if (IS_JUDGE(ch)) {
		...
		send_to_char( "You cannot set demon points.\n\r", ch );
	return;
    }
	...
	if (IS_JUDGE(ch)) {
		...
		send_to_char( "You cannot set status.\n\r", ch );
	return;
    }
	...
	if (IS_JUDGE(ch)) {
		...
		send_to_char( "You cannot set quest points.\n\r", ch );
	return;
    }
	...
	if (IS_JUDGE(ch)) {
		...
		send_to_char( "You cannot set stances.\n\r", ch );
	return;
    }
	...
	if (IS_JUDGE(ch)) {
		...
		send_to_char( "You cannot set magic levels.\n\r", ch );
	return;
    }
	...
	if (IS_JUDGE(ch)) 
		...
		send_to_char( "You cannot set immunities.\n\r", ch );
	return;
    }
	...
	if (IS_JUDGE(ch)) 
		...
		send_to_char( "You cannot set weapon skills.\n\r", ch );
	return;
    }
