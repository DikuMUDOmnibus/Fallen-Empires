...
#define AFF_STEELSHIELD       268435456 /* Monk Peace */
#define AFF_GODBLESS          536870912 /* Monk and Paladin Bless */
#define AFF_TOTALBLIND       1073741824 /* Total Blind, nothing can penerate */
#define AFF_LLOTHBLESS	     2147483648 /* Drow blessing */
/*
 * Bits for 'itemaffect'.
 * Used in #MOBILES.
 */
...
DECLARE_DO_FUN( do_paladinarmor );
