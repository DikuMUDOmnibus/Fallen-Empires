...
const	struct	cmd_type	cmd_table	[] =
{
    ...
    { "makepreg",	do_makepreg,	POS_DEAD,	 12, LOG_NORMAL },
  ...
  /*{ "donate",         do_donate,	POS_SITTING,	 0,  LOG_NORMAL },*/
    ...
    { "mikt",		do_mikt,	POS_DEAD,	 1,  LOG_NORMAL	},
    { "music",		do_music,	POS_SLEEPING,	 0,  LOG_NORMAL },
    { "note",		do_note,	POS_DEAD,	 0,  LOG_NORMAL	},
    { "paladin",	do_paladin,	POS_DEAD,	 1,  LOG_NORMAL	},
    ...
    { "arena",		do_arena,	POS_STANDING,	 2,  LOG_NORMAL },
    ...
    { "gomort",		do_gomort,	POS_STANDING,	 3,  LOG_NORMAL },
    ...
    { "aura",           do_aura,        POS_STANDING,    3,  LOG_NORMAL },
    ...
    { "discipline",	do_discipline,	POS_STANDING,	 5,  LOG_NORMAL	},
...
/* start moogle section */
    { "dances",		do_dances,	POS_STANDING,	3, LOG_NORMAL	},
    { "song",		do_wind_song,	POS_FIGHTING,   3, LOG_NORMAL   },
    { "suite",		do_forest_suite,POS_FIGHTING,  3,  LOG_NORMAL   },
    { "aria",		do_desert_aria, POS_FIGHTING,   3, LOG_NORMAL	},
    { "sonata",		do_love_sonata, POS_FIGHTING,   3, LOG_NORMAL	},
    { "blues",		do_earth_blues, POS_FIGHTING,   3, LOG_NORMAL	},
    { "rondo",		do_water_rondo, POS_FIGHTING,   3, LOG_NORMAL	},
    { "requiem",	do_dusk_requiem,POS_FIGHTING,    3, LOG_NORMAL  },
    { "jazz",		do_snowman_jazz,POS_FIGHTING,   3, LOG_NORMAL	},
...
/*start drow section */
    ...
    { "sign",		do_sign,	POS_DEAD,	3,   LOG_NORMAL },
...
/* end drow */
    ...
    { "kakusu",		do_kakusu,	POS_STANDING,	 3,  LOG_NORMAL	}, /* Enhanced Ninja Hide */
    { "almightyfavour",	do_almightyfavour,POS_DEAD,	 3,  LOG_NORMAL },
    { "touch", 	        do_prayer,      POS_DEAD,        3,  LOG_NORMAL },
    { "kanzuite",	do_kanzuite,	POS_DEAD,	 3,  LOG_NORMAL	}, /* Ninja Truesight */
    ...
    { "michi",		do_michi,	POS_FIGHTING,	 3,  LOG_NORMAL	}, /* Ninja */
    ...
    { "paladinarmor",   do_paladinarmor,POS_STANDING,    3,  LOG_NORMAL },
    { "palmthrust",     do_palmthrust,  POS_FIGHTING,    0,  LOG_NORMAL }, 
    { "pclan",          do_pclan,       POS_STANDING,    3,  LOG_NORMAL },
    { "poison",		do_poison,	POS_STANDING,	 3,  LOG_NORMAL	},
    { "pray",		do_pray,	POS_DEAD,	 0,  LOG_NORMAL	},
    { "prayerofages",   do_prayofages,  POS_STANDING,    3,  LOG_NORMAL },
    ...
    { "guide",		do_guide,	POS_SITTING,	 3,  LOG_NORMAL },
    ...
    { "zulo",		do_zulo,	POS_STANDING,	 0,  LOG_NORMAL	},

    /*
     * Immortal commands.
     */
    { "trust",		do_trust,	POS_DEAD,	12,  LOG_ALWAYS },
    { "allow",		do_allow,	POS_DEAD,	11,  LOG_ALWAYS	},
    { "ban",		do_ban,		POS_DEAD,	11,  LOG_ALWAYS	},
    { "bind",		do_bind,	POS_DEAD,	10,  LOG_ALWAYS	},
    { "bitchslap",      do_bitchslap,   POS_DEAD,       10,  LOG_ALWAYS },
    { "copyover",	do_copyover,	POS_STANDING,	10,  LOG_ALWAYS	},
    { "clearstats",	do_clearstats,	POS_STANDING,	 0,  LOG_NORMAL	},
    { "clearvam",	do_clearvam,	POS_STANDING,	10,  LOG_NORMAL },
    { "clearvamp",	do_clearvamp,	POS_STANDING,	10,  LOG_ALWAYS	},
    { "create",		do_create,	POS_STANDING,	 7,  LOG_NORMAL	},
    { "deny",		do_deny,	POS_DEAD,	11,  LOG_ALWAYS	},
    { "disable",	do_disable,	POS_DEAD,	11,  LOG_ALWAYS },
    { "disconnect",	do_disconnect,	POS_DEAD,	10,  LOG_ALWAYS	},
    { "divorce",	do_divorce,	POS_DEAD, 	10,  LOG_ALWAYS }, 
    { "familiar",	do_familiar,	POS_STANDING,	12,  LOG_NORMAL	},
    { "fcommand",	do_fcommand,	POS_STANDING,	 4,  LOG_NORMAL	},
    { "freeze",		do_freeze,	POS_DEAD,	 8,  LOG_ALWAYS	},
    { "marry",		do_marry,	POS_DEAD,       10,  LOG_ALWAYS },
    { "paradox",	do_paradox,	POS_DEAD,	11,  LOG_ALWAYS },
    { "qset",		do_qset,	POS_DEAD,	 7,  LOG_ALWAYS	},
    { "qstat",		do_qstat,	POS_DEAD,	 7,  LOG_ALWAYS	},
    { "qtrust",		do_qtrust,	POS_DEAD,      	 8,  LOG_ALWAYS },
    { "ntrust",		do_ntrust,	POS_DEAD,	 8,  LOG_ALWAYS	},
    ...
    { "wizlock",	do_wizlock,	POS_DEAD,	10,  LOG_ALWAYS	},
    ...
    { "mset",		do_mset,	POS_DEAD,	 7,  LOG_ALWAYS	},
    { "noemote",	do_noemote,	POS_DEAD,	 8,  LOG_ALWAYS	},
    { "notell",		do_notell,	POS_DEAD,	 8,  LOG_ALWAYS	},
    { "oclone",		do_oclone,	POS_DEAD,	 8,  LOG_NORMAL	},
    { "oload",		do_oload,	POS_DEAD,	 7,  LOG_ALWAYS	},
    { "oset",		do_oset,	POS_DEAD,	 7,  LOG_ALWAYS	},
    { "otransfer",	do_otransfer,	POS_DEAD,	 7,  LOG_ALWAYS	},
    { "pload",		do_pload,	POS_DEAD,	12,  LOG_ALWAYS	},
    { "pset",		do_pset,	POS_DEAD,        7,  LOG_ALWAYS	},
...
const	struct	social_type	social_table [] =
{
    ...
    {   "roflmao",
        "You roll around on the floor laughing your ass off.",
        "$n rolls around of the floor laughing $p ass off.",
        "You roll around on the floor laughing your ass off at $M's remark.",
        "$n rolls around on the floor laughing their ass off at $N",
        "$n rolls on the floor laughing their ass off at you. (Grumble).",
        "You roll on the floor laughing your ass off at what you did.",
        "$n rolls on the floor laughing at $mself, must be funny!",
    },
...
const	struct	xsocial_type	xsocial_table [] =
{
	...
	"$n ties you to the bed post, leaving you completeely at $s mercy",
	"Not on yourself!",
	NULL,
	0, 0, 0, 15, 10, FALSE
    },
	...
	"On whom do you wish to do this?",
	NULL,
	"You take $N's hot member in your hands, licking $S it.",
	"$n takes $N's penis in $s hands, licking $N's cock from base to tip.",
	"You gasp as $n takes your penis in $s hands, licking your head.",
	...
	"On whom do you wish to do this?",
	NULL,
	"You grab your pennis and begin to jerkoff for $N.",
	"$n grabs your pennis and begins to jerkoff for $N.",
	"$n grab your pennis and begin to jerkoff for your viewing pleasure.  What a turn on!.",
	"Not on yourself!",
	NULL,
	1, 1, 0, 25, 5, FALSE
    },
